...
fn has_road_avx2(road_occ: Bitboard) -> bool {
    ...
    let left_edge = _mm256_set1_epi64x(left_edge as i64);
    let right_edge = _mm256_set1_epi64x(right_edge as i64);
...
#[must_use]
fn has_road(road_occ: Bitboard) -> bool {
    #[cfg(target_feature = "avx2")]
    {
        //SAFETY: self-explanatory
        return unsafe { has_road_avx2(road_occ) };
    }
